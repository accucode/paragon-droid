...
/**
 * Here is the zxing intent integrator class
 */
...
public class IntentIntegrator
{
    ...
    {
        targetApplications = Collections.singleton(targetApplication);
    }
    ...
    private String findTargetAppPackage(Intent intent)
    {
        ...
        List<ResolveInfo> availableApps = pm.queryIntentActivities(
            intent,
        ...
        if ( requestCode == REQUEST_CODE )
        {
            if ( resultCode == Activity.RESULT_OK )
            {
                ...
                int intentOrientation = intent.getIntExtra(
                    ...
                    Integer.MIN_VALUE);
                Integer orientation = intentOrientation == Integer.MIN_VALUE
                    ? null
                    : intentOrientation;
